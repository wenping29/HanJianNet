-- ============================================
-- HanJianNet · SQLite 数据导出脚本
-- 源数据库: hanjian.db
-- 生成时间: 2026-08-25 11:01:57
-- 配套结构: sqlite-schema.sql（先执行建表）
-- 说明: 字符串按 SQLite 规则转义（单引号翻倍）；
--       整体包裹在事务中，导入原子生效
-- ============================================
...
-- Users (7 行)
INSERT INTO "Users" ("Id", "Username", "Email", "PasswordHash", "Role", "CreatedAt") VALUES ('1cdc5e7dfe9d4eb5b8df08085ed474a0', 'admin', 'admin@hanjiannet.local', '$2a$11$cRIk2CQ3BqWZTq7CHHx2w.5zY1bOFQRLu8ItxpKlMwYfwu6Ng9T4a', 'superadmin', '2026-08-23 11:24:42.7434152');
INSERT INTO "Users" ("Id", "Username", "Email", "PasswordHash", "Role", "CreatedAt") VALUES ('3fd874ddbefb42a7ba0e087e7a83a5ef', 'testuser', 'testuser@hanjiannet.local', '$2a$11$dBuyO1RUUXiheRS70jIL1uGMaLnXSXFAV1oo9zxcLFMqU51iGfpj6', 'user', '2026-08-23 11:24:43.7694321');
INSERT INTO "Users" ("Id", "Username", "Email", "PasswordHash", "Role", "CreatedAt") VALUES ('5268e40985094514810f3df61512d8d1', 'testadmin', 'testadmin@hanjiannet.local', '$2a$11$I.Swne.sc8.aO6xBtrBWlehDI.t4ExiblDUznUOt5kYDew2yPG4hG', 'admin', '2026-08-23 11:24:43.1340336');
...
INSERT INTO "Users" ("Id", "Username", "Email", "PasswordHash", "Role", "CreatedAt") VALUES ('8b32f4388a9a4e5e9446cbd25b1d90b7', 'testguest', 'testguest@hanjiannet.local', '$2a$11$dfIk8W4QJ/4VUecQ67dyj.hiq.CdNjOlebe3FowO55UuOn3uPJm4K', 'guest', '2026-08-23 11:24:44.0783448');
INSERT INTO "Users" ("Id", "Username", "Email", "PasswordHash", "Role", "CreatedAt") VALUES ('56c9628b134c4244801b6f00f39ef07f', 'rbac_test', 'rbac_test@hanjiannet.local', '$2a$11$dSWuyL/MeD3IxyvE4lgHmOA1pROiPgHzssBo9XydUxjPoTr69El.S', 'user', '2026-08-23 12:04:28.4470557');
INSERT INTO "Users" ("Id", "Username", "Email", "PasswordHash", "Role", "CreatedAt") VALUES ('4b1e6d3870e248f98aa608b3e8ef2fcd', 'admin2', 'admin2@test.local', '$2a$11$Ku38rJb21ygL33h9IYp6z.A6GypoXsCd5RXygubjDVzTaFlgrrAo.', 'admin', '2026-08-23 12:12:16.7089205');

-- Roles (5 行)
INSERT INTO "Roles" ("Id", "Key", "Name", "Description", "Sort", "IsBuiltIn", "CreatedAt") VALUES ('3863bc21de8c4c2c95d005e5376642b9', 'guest', '游客', '仅查看公开档案', 0, 1, '2026-08-23 11:24:42.1454598');
INSERT INTO "Roles" ("Id", "Key", "Name", "Description", "Sort", "IsBuiltIn", "CreatedAt") VALUES ('43c94ad5b840471db369fa7279122d58', 'user', '普通用户', '提交修订，查看档案', 1, 1, '2026-08-23 11:24:42.1454595');
INSERT INTO "Roles" ("Id", "Key", "Name", "Description", "Sort", "IsBuiltIn", "CreatedAt") VALUES ('6d75cb9d8b7c4c14883b7ac25470b71c', 'manager', '管理', '审核修订，可编辑档案', 2, 1, '2026-08-23 11:24:42.1454593');
INSERT INTO "Roles" ("Id", "Key", "Name", "Description", "Sort", "IsBuiltIn", "CreatedAt") VALUES ('7f716519c70345a2b6fc5362a89b45a6', 'admin', '管理员', '系统管理，含用户/角色/菜单管理', 3, 1, '2026-08-23 11:24:42.1454589');
INSERT INTO "Roles" ("Id", "Key", "Name", "Description", "Sort", "IsBuiltIn", "CreatedAt") VALUES ('802c0cfbbe2949b2b0619c9ebdb34015', 'superadmin', '超级管理员', '拥有全部权限，不可删除', 4, 1, '2026-08-23 11:24:42.1453381');
...
INSERT INTO "Permissions" ("Id", "Key", "Name", "Group", "CreatedAt") VALUES ('5998e12cd39e4426b8670322e52278e6', 'roles', '角色管理', 'menu', '2026-08-23 11:24:42.6613729');
INSERT INTO "Permissions" ("Id", "Key", "Name", "Group", "CreatedAt") VALUES ('8df50fbefa664c8b8d01294d25510330', 'menus', '菜单管理', 'menu', '2026-08-23 11:24:42.6689413');
INSERT INTO "Permissions" ("Id", "Key", "Name", "Group", "CreatedAt") VALUES ('949d3499751b47cfbbc4fda85ea21e46', 'users', '用户管理', 'menu', '2026-08-23 11:24:42.6689696');
INSERT INTO "Permissions" ("Id", "Key", "Name", "Group", "CreatedAt") VALUES ('d6d500629f854eeba59422b5fde8db89', 'traitors', '名录管理', 'menu', '2026-08-23 11:24:42.6689894');
INSERT INTO "Permissions" ("Id", "Key", "Name", "Group", "CreatedAt") VALUES ('db9673e9f00848e895db8a9eadf0f560', 'system', '系统管理', 'menu', '2026-08-23 11:24:42.6689573');
INSERT INTO "Permissions" ("Id", "Key", "Name", "Group", "CreatedAt") VALUES ('deb91df4286840179dea6ea6dc00e1c9', 'reviews', '待审队列', 'menu', '2026-08-23 11:24:42.6688267');
...
INSERT INTO "RolePermissions" ("Id", "RoleKey", "PermissionKey", "CreatedAt") VALUES ('1f19511ade684dfc9812276dda760f8b', 'superadmin', 'menus', '2026-08-23 11:24:42.7008318');
INSERT INTO "RolePermissions" ("Id", "RoleKey", "PermissionKey", "CreatedAt") VALUES ('3e223807f8194624bd0a915c445087af', 'admin', 'menus', '2026-08-23 11:24:42.7008228');
...
INSERT INTO "RolePermissions" ("Id", "RoleKey", "PermissionKey", "CreatedAt") VALUES ('4968ec7fe4dc4adbb124499dc0dcbe1a', 'superadmin', 'system', '2026-08-23 11:24:42.7008601');
INSERT INTO "RolePermissions" ("Id", "RoleKey", "PermissionKey", "CreatedAt") VALUES ('6bd77b66f5b94012aa4285cd321d4ee6', 'manager', 'system', '2026-08-23 11:24:42.7008408');
INSERT INTO "RolePermissions" ("Id", "RoleKey", "PermissionKey", "CreatedAt") VALUES ('7d70489b099f450d8e8dfcc7496211a9', 'admin', 'users', '2026-08-23 11:24:42.7008759');
...
INSERT INTO "RolePermissions" ("Id", "RoleKey", "PermissionKey", "CreatedAt") VALUES ('7de7412bee1a462f8dd6be9e366a805a', 'superadmin', 'reviews', '2026-08-23 11:24:42.7008111');
INSERT INTO "RolePermissions" ("Id", "RoleKey", "PermissionKey", "CreatedAt") VALUES ('9c36b859be3e49fbba602d1a98a47eaf', 'superadmin', 'profile', '2026-08-23 11:24:42.7009138');
INSERT INTO "RolePermissions" ("Id", "RoleKey", "PermissionKey", "CreatedAt") VALUES ('a8a07b7c7d7041a287c2e2799e51b4d7', 'superadmin', 'users', '2026-08-23 11:24:42.7008869');
INSERT INTO "RolePermissions" ("Id", "RoleKey", "PermissionKey", "CreatedAt") VALUES ('ac639381b3644944bded28276d710ca2', 'admin', 'roles', '2026-08-23 11:24:42.6948271');
INSERT INTO "RolePermissions" ("Id", "RoleKey", "PermissionKey", "CreatedAt") VALUES ('b62102467c9447d2be078beb64c5ef34', 'superadmin', 'traitors', '2026-08-23 11:24:42.7009322');
INSERT INTO "RolePermissions" ("Id", "RoleKey", "PermissionKey", "CreatedAt") VALUES ('b6e04ea6631e47c7ae16613e67015ace', 'admin', 'reviews', '2026-08-23 11:24:42.7007541');
INSERT INTO "RolePermissions" ("Id", "RoleKey", "PermissionKey", "CreatedAt") VALUES ('bf13aa8b514e428bbb6a1903f5f7dd41', 'admin', 'system', '2026-08-23 11:24:42.7008511');
INSERT INTO "RolePermissions" ("Id", "RoleKey", "PermissionKey", "CreatedAt") VALUES ('c48aaf753ca54a0da57f07dcc56d3c7b', 'admin', 'profile', '2026-08-23 11:24:42.7009047');
INSERT INTO "RolePermissions" ("Id", "RoleKey", "PermissionKey", "CreatedAt") VALUES ('cc61debe4d014585b7e5b5591adbf0fb', 'manager', 'reviews', '2026-08-23 11:24:42.7007392');
INSERT INTO "RolePermissions" ("Id", "RoleKey", "PermissionKey", "CreatedAt") VALUES ('00869330caa343488fdde7af6af5a6c1', 'user', 'profile', '2026-08-23 12:11:27.2601455');

-- MenuItems (7 行)
INSERT INTO "MenuItems" ("Id", "Key", "Path", "Label", "Icon", "Sort", "Parent", "CreatedAt") VALUES ('0cbdafbe2d214dff89f33bf6e873504e', 'roles', '/roles', '角色管理', NULL, 2, 'system', '2026-08-23 11:24:42.6244544');
...
INSERT INTO "MenuItems" ("Id", "Key", "Path", "Label", "Icon", "Sort", "Parent", "CreatedAt") VALUES ('3cfb01bce15041c69d888b43a7c6334b', 'menus', '/menus', '菜单管理', NULL, 3, 'system', '2026-08-23 11:24:42.6247241');
INSERT INTO "MenuItems" ("Id", "Key", "Path", "Label", "Icon", "Sort", "Parent", "CreatedAt") VALUES ('582aa55c3b014a4d8085b5c111b1c73c', 'system', '/system', '系统管理', NULL, 3, NULL, '2026-08-23 11:24:42.6238916');
INSERT INTO "MenuItems" ("Id", "Key", "Path", "Label", "Icon", "Sort", "Parent", "CreatedAt") VALUES ('98c32a7766cb4fd2b2200b95040c5bd5', 'users', '/users', '用户管理', NULL, 1, 'system', '2026-08-23 11:24:42.6241693');
INSERT INTO "MenuItems" ("Id", "Key", "Path", "Label", "Icon", "Sort", "Parent", "CreatedAt") VALUES ('dd450d2d3cd44c3ebbf0a2819389dd89', 'profile', '/profile', '个人信息', NULL, 4, 'system', '2026-08-23 11:24:42.6249718');
INSERT INTO "MenuItems" ("Id", "Key", "Path", "Label", "Icon", "Sort", "Parent", "CreatedAt") VALUES ('f6c9b70f8c014f3d806822f11f83c19b', 'traitors', '/traitors', '名录管理', NULL, 1, NULL, '2026-08-23 11:24:42.5981891');

-- Traitors (8 行)
INSERT INTO "Traitors" ("Id", "Name", "CourtesyName", "Pseudonym", "BirthYear", "DeathYear", "BirthYearType", "DeathYearType", "NativePlace", "AliasesJson", "IdentityTagsJson", "Period", "Faction", "Summary", "RelatedIdsJson", "CreatedAt", "UpdatedAt") VALUES ('5cd9d2c429624c9190edc1a12b5a07da', '殷汝耕', '亦农', NULL, 1885, 1947, 'exact', 'exact', '浙江平阳', '["\u6BB7\u4EA6\u519C"]', '["\u4F2A\u5180\u4E1C\u9632\u5171\u81EA\u6CBB\u653F\u5E9C\u4E3B\u5E2D","\u534E\u5317\u8001\u724C\u6C49\u5978"]', '抗日战争时期', '伪冀东防共自治政府 / 汪伪政权', '殷汝耕，字亦农，浙江平阳人。早年留学日本，毕业于早稻田大学，娶日本女子为妻。北洋时期服务于各系军阀。1935年11月25日在河北通县成立「冀东防共自治委员会」，后改称「冀东防共自治政府」，任主席，是抗战前第一个公开独立的汉奸政权。1947年12月1日在南京老虎桥监狱被执行枪决。', '[]', '2026-08-23 12:19:50.9151279', '2026-08-23 12:19:50.9151281');
INSERT INTO "Traitors" ("Id", "Name", "CourtesyName", "Pseudonym", "BirthYear", "DeathYear", "BirthYearType", "DeathYearType", "NativePlace", "AliasesJson", "IdentityTagsJson", "Period", "Faction", "Summary", "RelatedIdsJson", "CreatedAt", "UpdatedAt") VALUES ('de2f04e471c34e19a14d8b72403fec6a', '汪精卫', '季新', '精卫', 1883, 1944, 'exact', 'exact', '浙江绍兴府山阴县', '["\u6C6A\u5146\u94ED","\u6C6A\u5B63\u65B0"]', '["\u4F2A\u56FD\u6C11\u653F\u5E9C\u4E3B\u5E2D","\u5934\u53F7\u6C49\u5978","\u540C\u76DF\u4F1A\u5143\u8001","\u653F\u6CBB\u5BB6"]', '抗日战争时期', '汪伪政权 / 中国国民党', '汪兆铭，笔名精卫，历史上多以「汪精卫」称呼。祖籍浙江山阴（今绍兴），出生于广东三水（今属佛山市），是民国时期的重要政治人物。早年投身革命，曾谋刺清摄政王载沣未遂，袁世凯统治时期赴法国留学。回国后于1919年在孙中山领导下，驻上海创办《建设》杂志。1921年孙文在广州就任大总统，汪精卫任广东省教育会长、广东政府顾问。1924年任中央宣传部长。后期思想明显退变，于抗日战争期间投靠日本，在南京成立伪国民政府，沦为汉奸。1944年在日本名古屋因「骨髓肿」病死。', '[]', '2026-08-23 12:23:34.7609685', '2026-08-23 12:23:34.7609686');
INSERT INTO "Traitors" ("Id", "Name", "CourtesyName", "Pseudonym", "BirthYear", "DeathYear", "BirthYearType", "DeathYearType", "NativePlace", "AliasesJson", "IdentityTagsJson", "Period", "Faction", "Summary", "RelatedIdsJson", "CreatedAt", "UpdatedAt") VALUES ('947e029bf0874fde984f509d4bb0c70c', '陈公博', NULL, NULL, 1892, 1946, 'exact', 'exact', '广东乳源', '[]', '["\u4F2A\u7ACB\u6CD5\u9662\u957F","\u4F2A\u56FD\u5E9C\u4EE3\u4E3B\u5E2D","\u4E8C\u53F7\u6C49\u5978"]', '抗日战争时期', '汪伪政权', '陈公博，原籍广东乳源，寄籍南海。1920年毕业于北京大学哲学系。1921年出席中共一大，1922年退党后赴美留学。1925年加入中国国民党，先后任广东大学教授、国民党中央党部书记长等职。1938年随汪精卫投敌，历任汪伪国民党中央执委、立法院院长、上海市市长、国民政府代主席。1946年4月以汉奸罪在苏州被判处死刑，同年6月3日被枪决。', '[]', '2026-08-23 12:23:34.9647619', '2026-08-23 12:23:34.964762');
INSERT INTO "Traitors" ("Id", "Name", "CourtesyName", "Pseudonym", "BirthYear", "DeathYear", "BirthYearType", "DeathYearType", "NativePlace", "AliasesJson", "IdentityTagsJson", "Period", "Faction", "Summary", "RelatedIdsJson", "CreatedAt", "UpdatedAt") VALUES ('8a997e9c473c4d02933ca468d493ca84', '周佛海', NULL, NULL, 1897, 1948, 'exact', 'exact', '湖南沅陵', '[]', '["\u4F2A\u884C\u653F\u9662\u526F\u9662\u957F","\u4F2A\u8D22\u653F\u90E8\u957F","\u4E09\u53F7\u6C49\u5978"]', '抗日战争时期', '汪伪政权', '周佛海，湖南沅陵人。早年留学日本，1921年作为旅日代表出席中共一大，1924年退出共产党加入国民党。抗战爆发后随汪精卫投敌，历任汪伪国民党中央执委、中央政治委员会委员、行政院副院长兼财政部长、警政部长、中央储备银行总裁。日本投降前与军统戴笠秘密联系，为重庆方面效力。1946年被判处死刑，后蒋介石特赦改判无期徒刑。1948年2月28日病死南京老虎桥监狱。', '[]', '2026-08-23 12:23:35.0043737', '2026-08-23 12:23:35.0043738');
INSERT INTO "Traitors" ("Id", "Name", "CourtesyName", "Pseudonym", "BirthYear", "DeathYear", "BirthYearType", "DeathYearType", "NativePlace", "AliasesJson", "IdentityTagsJson", "Period", "Faction", "Summary", "RelatedIdsJson", "CreatedAt", "UpdatedAt") VALUES ('ba4b4b594302468d8908433669e0f300', '褚民谊', '重行', NULL, 1884, 1946, 'exact', 'exact', '浙江乌程（今湖州）', '[]', '["\u4F2A\u884C\u653F\u9662\u79D8\u4E66\u957F","\u4F2A\u5916\u4EA4\u90E8\u957F","\u6C6A\u4F2A\u6838\u5FC3"]', '抗日战争时期', '汪伪政权', '褚民谊，字重行，浙江吴兴人，汪精卫连襟（妻陈舜贞为陈璧君之妹）。早年留学日本、法国，获医学博士学位。1906年加入同盟会，为国民党元老。1939年随汪投敌，历任汪伪国民党中央监察委员会常委、行政院秘书长、外交部长、广东省省长。1946年8月23日以汉奸罪在苏州被执行枪决。', '[]', '2026-08-23 12:23:35.0503785', '2026-08-23 12:23:35.0503786');
INSERT INTO "Traitors" ("Id", "Name", "CourtesyName", "Pseudonym", "BirthYear", "DeathYear", "BirthYearType", "DeathYearType", "NativePlace", "AliasesJson", "IdentityTagsJson", "Period", "Faction", "Summary", "RelatedIdsJson", "CreatedAt", "UpdatedAt") VALUES ('96c2476c9fc648c58f17d4832e380681', '陈璧君', '冰如', NULL, 1891, 1959, 'exact', 'exact', '广东新会', '["\u9648\u51B0\u5982"]', '["\u6C6A\u7CBE\u536B\u4E4B\u59BB","\u4F2A\u4E2D\u592E\u76D1\u5BDF\u59D4\u5458","\u5934\u53F7\u5973\u6C49\u5978"]', '抗日战争时期', '汪伪政权', '陈璧君，字冰如，原籍广东新会，生于马来亚槟榔屿。南洋富商陈耕基之女。1908年在槟城听汪精卫演说后倾心，资助其革命事业。1912年与汪在上海结婚。抗战爆发后极力怂恿汪精卫投敌，是汪集团投敌的核心推手。汪伪政权成立后任伪中央监察委员会常委、政治委员会委员。1945年9月在广州被捕，1946年4月以汉奸罪被判处无期徒刑，1949年后由苏州监狱移送上海提篮桥监狱。1959年6月17日病死于狱中，年68岁。', '[]', '2026-08-23 12:23:35.0799775', '2026-08-23 12:23:35.0799776');
INSERT INTO "Traitors" ("Id", "Name", "CourtesyName", "Pseudonym", "BirthYear", "DeathYear", "BirthYearType", "DeathYearType", "NativePlace", "AliasesJson", "IdentityTagsJson", "Period", "Faction", "Summary", "RelatedIdsJson", "CreatedAt", "UpdatedAt") VALUES ('dafd3a63886e4dd8b1d67f959a4c862a', '王克敏', '叔鲁', NULL, 1873, 1945, 'exact', 'exact', '浙江杭县（今余杭）', '["\u738B\u53D4\u9C81"]', '["\u4F2A\u534E\u5317\u4E34\u65F6\u653F\u5E9C\u59D4\u5458\u957F","\u534E\u5317\u5934\u53F7\u6C49\u5978"]', '抗日战争时期', '华北伪临时政府 / 汪伪政权', '王克敏，字叔鲁，浙江杭县人，举人出身。清末留日。民国时期历任中国银行总裁、财政总长、北平政务委员会委员等职。1937年12月在日本扶植下于北平成立「中华民国临时政府」，任行政委员会委员长。1940年并入汪伪政权后，任「华北政务委员会」委员长。1945年8月日本投降后被捕，12月25日在北平狱中畏罪服毒自杀，年72岁。', '[]', '2026-08-23 12:23:35.1119692', '2026-08-23 12:23:35.1119693');
INSERT INTO "Traitors" ("Id", "Name", "CourtesyName", "Pseudonym", "BirthYear", "DeathYear", "BirthYearType", "DeathYearType", "NativePlace", "AliasesJson", "IdentityTagsJson", "Period", "Faction", "Summary", "RelatedIdsJson", "CreatedAt", "UpdatedAt") VALUES ('1a5c0a4489ec4433931fd8a26d608e69', '梁鸿志', '众异', NULL, 1882, 1946, 'exact', 'exact', '福建长乐', '["\u6881\u4F17\u5F02"]', '["\u4F2A\u7EF4\u65B0\u653F\u5E9C\u884C\u653F\u9662\u957F","\u534E\u4E2D\u5934\u53F7\u6C49\u5978"]', '抗日战争时期', '南京伪维新政府 / 汪伪政权', '梁鸿志，字众异，福建长乐人。晚清巨儒梁章钜曾孙。1905年入京师大学堂。北洋时期任段祺瑞执政府秘书长。1938年3月在日本扶植下于南京成立「中华民国维新政府」，任行政院长。1940年并入汪伪，任监察院长、立法院长。1946年5月以汉奸罪被判死刑，11月9日在上海提篮桥监狱被执行枪决。', '[]', '2026-08-23 12:23:35.1549278', '2026-08-23 12:23:35.1549279');
