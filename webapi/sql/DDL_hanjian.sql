...
CREATE TABLE `traitors` (
  ...
  `CourtesyName` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `Pseudonym` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `BirthYear` int DEFAULT NULL,
  `DeathYear` int DEFAULT NULL,
  `BirthYearType` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `DeathYearType` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `NativePlace` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `AliasesJson` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `IdentityTagsJson` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Period` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Faction` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Summary` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `RelatedIdsJson` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `Town` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `atrocitycases` (
  `Id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Name` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '事件名称',
  `Alias` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '别名',
  `EventType` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '事件类型(惨案/屠杀/大屠杀/事变/战役/国难)',
  `Era` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '时期(宋末/明末/清末/民国/抗日战争时期/其他)',
  ...
  `Location` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '发生地点',
  `IsGeneral` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否通用描述（0=具体惨案 1=泛称）',
  `PersonCount` int NOT NULL DEFAULT '0' COMMENT '涉案人员数',
  `Summary` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '典型罪行摘要/事件描述',
  `Keywords` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '关联检索关键词(JSON)',
  `CreatedAt` datetime(6) NOT NULL,
  `UpdatedAt` datetime(6) NOT NULL,
  PRIMARY KEY (`Id`),
...
CREATE TABLE `atrocitycasepersons` (
  `Id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `AtrocityCaseId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '所属事件Id',
  `Name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '涉案人员姓名',
  `Location` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '人员地级信息',
  `IdentityTags` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '身份/罪行描述',
...
CREATE TABLE `attachments` (
  `Id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `TraitorId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Url` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Kind` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `FileType` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `children` (
  ...
  `Whereabouts` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
...
CREATE TABLE `contactmessages` (
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_ContactMessages_CreatedAt` (`CreatedAt`),
  KEY `IX_ContactMessages_IsHandled` (`IsHandled`)
...
CREATE TABLE `crimerecords` (
  ...
  `Process` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `Harm` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `SourceRef` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
...
CREATE TABLE `errorlogs` (
  ...
  `Role` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Level` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ExceptionType` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Message` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `StackTrace` varchar(8192) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `Query` varchar(2048) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `RequestBody` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `Ip` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `UserAgent` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ClientSource` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci
;
...
CREATE TABLE `lifeevents` (
  ...
  `TraitorId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Year` int DEFAULT NULL,
  `Event` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `SourceRef` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  PRIMARY KEY (`Id`),
...
CREATE TABLE `menuitems` (
  ...
  `Label` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `operationlogs` (
  ...
  `TargetId` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `TargetLabel` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `StatusCode` int NOT NULL,
...
CREATE TABLE `permissions` (
  ...
  `Key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Name` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Group` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `CreatedAt` datetime(6) NOT NULL,
  PRIMARY KEY (`Id`),
...
CREATE TABLE `residences` (
  ...
  `Period` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `Remark` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  PRIMARY KEY (`Id`),
...
CREATE TABLE `rolepermissions` (
  `Id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `RoleKey` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `PermissionKey` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `CreatedAt` datetime(6) NOT NULL,
  PRIMARY KEY (`Id`),
...
CREATE TABLE `sources` (
  `Id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `TraitorId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Citation` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `revisions` (
  `Id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `TraitorId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SubmitterId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `SubmittedAt` datetime(6) NOT NULL,
  `ChangeSummary` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `PayloadJson` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Status` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ReviewerId` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ReviewedAt` datetime(6) DEFAULT NULL,
  `ReviewResult` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `ReviewComment` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  PRIMARY KEY (`Id`),
